   ...
   public void startTest() {
       unit = new Temperature();
        ...
        public void check_02_Methods() throws NoSuchFieldException, IllegalAccessException {
            ...
            unit.setCelsius(value);
            assertEquals("Wrong setCelcius Method",(double)getFieldValue(unit,"celcius"),value,0.01);
            assertEquals("Wrong getCelcius Method",unit.getCelsius(),value,0.01);
            ...
            assertEquals("Wrong convert Method",unit.convert("°C", "°C", value),unit.getCelsius(),0.01);
            ...
            assertEquals("Wrong convert Method",unit.convert("°F", "°C", value),unit.getCelsius(),0.01);
            ...
            assertEquals("Wrong convert Method",unit.convert("K", "°C", value),unit.getCelsius(),0.01);
